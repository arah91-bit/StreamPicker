...
The dashboard is one site with five tabs — Overview, Connections, Settings,
Source health, Private Trackers —
served at clean paths (/, /connections, /settings, /stats) on the
container's own port, with no secret in the URL. The addon's public endpoints (manifest/stream/proxy) keep
